...
#tts1 = gtts.gTTS("Detected As "+Plabel,lang='en',tld='co.in')
#tts1.save(Plabel+".mp3")
...
match maxindex:
    ...
    case  2:
        ...
        msg1="Iron deficiency causes   :"+\
        "1  Iron deficiency is also common when soils are cool"+\
        "2 high in calcium, poorly drained, or waterlogged and when root\n      health is impaired by root decay pathogens, nematodes, \n       or other biological or physical causes"
    ...
    case  3:
        ...
        msg1="Potassium deficiency causes :"+\
    ...
    case   4:
        ...
        msg1="P (Phosphorus) deficiency causes :"+\
        "Causes are soil or root problems as described for nitrogen deficiency\n      that prevent roots from adequately absorbing phosphorus.\n      Certain herbicides also cause leaf distortion and curling \n        that can resemble phosphorus deficiency symptoms"
        tts1 = gtts.gTTS(msg1,lang='en',tld='co.in')
        tts1.save("4.mp3")
        playsound("4.mp3")
