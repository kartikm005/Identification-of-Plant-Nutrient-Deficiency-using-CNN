...
def check_all_images():
    ...
    print("Complete Accuracy Analysis",file=s)
    ...
    for foldername in glob.glob("Test/*"):
           ...
           # print('='*50,file=s)
            print(Alabel,' Classification Accuracy ',round(gacc,2),' %',file=s)
           # print('='*50,file=s)    
    ...
    print('\nTotal Accuracy ',round(acc,2),' %',file=s)
    ...
    print('\nConfusion Matrix',file=s)
    print(confusion,file=s)

    from sklearn.metrics import accuracy_score, precision_score, recall_score, f1_score
    print('\n\nPrecision: {:.2f}'.format(precision_score(tot_target, tot_output, average='micro')))
    print('Recall: {:.2f}'.format(recall_score(tot_target, tot_output, average='micro')))
    print('F1-score: {:.2f}\n'.format(f1_score(tot_target, tot_output, average='micro')))

    print('Precision: {:.2f}'.format(precision_score(tot_target, tot_output, average='micro')),file=s)
    print('Recall: {:.2f}'.format(recall_score(tot_target, tot_output, average='micro')),file=s)
    print('F1-score: {:.2f}\n'.format(f1_score(tot_target, tot_output, average='micro')),file=s)
    ...
    print('\nClassification Report\n',file=s)
    print(classification_report(tot_target, tot_output),file=s)
